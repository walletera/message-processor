...
func (_c *MockConsumer_Consume_Call) Return(_a0 <-chan Message, _a1 error) *MockConsumer_Consume_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockConsumer_Consume_Call) RunAndReturn(run func() (<-chan Message, error)) *MockConsumer_Consume_Call {
	_c.Call.Return(run)
	return _c
}
